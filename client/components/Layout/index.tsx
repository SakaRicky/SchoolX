				...
				{navCategories.map(item => (
					<ListItem
						...
						className={`${classes.navItem} ${
							router.pathname === item.path ? classes.active : undefined
						}`}
					>
						<ListItemIcon style={{ fontSize: "25px", color: "#fff" }}>
							{<item.icon />}
						</ListItemIcon>
				...
				<Toolbar className={classes.appToolbar}>
					...
					<div className={classes.profile}>
						<Typography className={classes.username}>
							{state.user && state.user.names}
						</Typography>
						<Avatar {...stringAvatar(state.user?.names)} />
					</div>
				</Toolbar>
			</AppBar>
